...
- agents
  ...
  - query clarify node [query_classification_agent.py (บรรทัด 25–174)](https://github.com/ffahpatcha/senior_project_update/blob/main/outOfDomain_google_error/agents/query_classification_agent.py#L25-L174)
  - query classification node [query_classification_agent.py (บรรทัด 177-325)](https://github.com/ffahpatcha/senior_project_update/blob/main/outOfDomain_google_error/agents/query_classification_agent.py#L177-L325)
